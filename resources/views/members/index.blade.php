@extends('layouts.app')
@section('title', 'Data List Anggota')
@section('content')
    <div
        ...
        <h2 class="intro-y mt-10 text-lg font-medium">Data Member</h2>
                            ...
                            <tr data-tw-merge="" class="intro-x">
                                ...
                                <td data-tw-merge=""
                                    ...
                                    <div class="flex items-center justify-center">
                                        <a class="mr-3 flex items-center" href="{{ route('member.edit', $member->id) }}">
                                            Edit
                                        </a>
                                        @if ($member->status == 1)
                                            <a class="btn btn-danger flex items-center text-danger" data-tw-toggle="modal"
                                                data-tw-target="#delete-confirmation-modal" href="#">
                                                Off
                                            </a>
                                        @else
                                            <a class="btn btn-success flex items-center text-success" data-tw-toggle="modal"
                                                data-tw-target="#delete-confirmation-modal" href="#">
                                                On
                                            </a>
                                        @endif
